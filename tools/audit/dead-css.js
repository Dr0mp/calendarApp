...
const tok=new Set(src.match(/[A-Za-z_][\w-]*/g));['label-hour','label-next-day','label-next-week','toast--info','toast--success','toast--warning','toast--danger'].forEach(c=>tok.add(c));
